...
public class AuthService {
    ...
    public UserDto signUp(SignupRequest request) {
        if (request == null || !Boolean.TRUE.equals(request.accepted_terms())) {
            throw ApiException.badRequest("Please accept the Terms and Privacy Policy to create an account.");
        }
        return signIn(new LoginRequest(request.email(), request.password()));
    }
